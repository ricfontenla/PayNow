...
describe Order do
  ...
  context 'if card' do
    ...
    it {
      should validate_length_of(:card_number)
        .is_equal_to(16).with_message('não possui o tamanho esperado (16 caracteres)')
    }
    it {
      should validate_length_of(:verification_code)
        .is_equal_to(3).with_message('não possui o tamanho esperado (3 caracteres)')
    }
